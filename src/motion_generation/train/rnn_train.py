...
os.environ["GENSIM_DATA_DIR"] = "/home/paolo/Projects/Posemi/dataset/gensim_data"
...
from motion_generation.models import GestureRNN
...
def main(config):
    ...
    # ===== 3. Crea Modello =====
    print("Creating GestureRNN model...")
    model = GestureRNN(
